...
export default function Home() {
   ...
   const [markers, setMarkers] = useState([
      { key: 0, image: require('../assets/carro.png'), coods: { latitude: -15.8080374, longitude: -47.8750231 }, pinColor: '#F00' },

      { key: 1, image: require('../assets/carro_left.png'), coods: { latitude: -15.8380374, longitude: -47.8850231 }, pinColor: '#0F0' },

      { key: 2, image: require('../assets/carro_down.png'), coods: { latitude: -15.8480374, longitude: -47.8950231 }, pinColor: '#00F' },

      { key: 3, image: require('../assets/carro.png'), coods: { latitude: -23.5492243, longitude: -46.5813785 }, pinColor: '#0FF' },

      { key: 4, image: require('../assets/carro.png'), coods: { latitude: -23.606966982022893, longitude: -46.66390204888366 }, pinColor: '#0F0' },
   ])
